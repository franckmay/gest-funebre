...
<?php include("include/side_bar.php"); ?>
  ...
  <div class="panel-heading" style="background-color:#c4e17f;">
	<h1>Ajouter Utilisateur  </h1></div><br>
	
<form action="add_user.php" name="form" method="post">
<div class="col-sm-6">
    <input name="first_name" class="input-lg" type="text"  id="first_name" style="font-size:18px; width:330px" placeholder="Nom" autofocus required><br><br>
</div>
<div class="col-sm-6">
<input name="last_name" class="input-lg" type="text"  id="last_name" style="font-size:18px; width:330px" placeholder="Prenom" autofocus required><br><br>
    </div>
    <div class="col-sm-6">
...
<input name="user_password" class="input-lg" type="text"  id="user_password" style="font-size:18px; width:330px"  placeholder="Password" required><br><br>
     ...
     <div class="col-sm-6">
    <input name="mobile" class="input-lg" type="phone"  id="mobile" style="font-size:18px; width:330px" placeholder="Telephone" autofocus required><br><br>
    </div>
     <div class="col-sm-6">
...
<div class="col-sm-7" style="margin:20px;margin-left:90px;">
    <button type="submit" class="btn btn-success btn-block center" name="btn_save" id="btn_save" style="font-size:18px">Valider</button></div>
</form>
</div></div>
