...
<div class="panel-heading" style="background-color:#c4e17f">
	<h1>Gerer utilisateurs </h1></div><br>
...
<table class="table table-bordered table-hover table-striped" style="font-size:18px">
	<tr>
                ...
                <th>Mot de passe</th>
	<th><a href="add_user.php">Ajouter</a></th></tr>	
<?php 
...
echo"<td>
<a href='edit_user.php?user_id=$user_id'>Modifier</a>
<a href='manage_users.php?user_id=$user_id&action=delete'>Supprimer</a>
</td></tr>";
}
mysqli_close($con);
?>
